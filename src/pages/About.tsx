...
const About = () => {
  return (
    <>
      <Helmet>
        <title>About — Shipper</title>
        <meta name="description" content="Built by logistics leaders who want a new industry standard in the yard. Learn about Shipper's mission and team." />
      </Helmet>
<main className="overflow-hidden">
      ...
      <FeatureSection 
        ...
        description="Well capitalized, supported by leading operators, and backed by a VC-firm driven by a 'build' investment philosophy, Shipper is uniquely de-risked. Our foundational partnerships and funding position is not as a startup, but as the emerging standard for modern yard operations."
