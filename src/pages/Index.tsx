...
const Index = () => (
  <>
    <Helmet>
      <title>Shipper — The Yard of the Future</title>
      <meta name="description" content="Shipper is reinventing the future of logistics through the yard with AI-native technology that turns manual tasks into connected missions." />
    </Helmet>
