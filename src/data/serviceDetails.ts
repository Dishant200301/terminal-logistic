...
export const serviceDetailsData: Record<string, ServiceDetail> = {
  "gate-automation": {
    ...
    overviewText: "Gate congestion eats into driver hours and facility throughput. Shipper's Automated Gate system validates identity, reads trailer numbers using advanced OCR, checks appointment status, and directs drivers to their precise drop location—all in less than 30 seconds without manual intervention.",
    features: [
  ...
  "yard-visibility": {
    ...
    overviewText: "If you don't know exactly what is in your yard, you can't optimize it. Shipper deploys a web of IoT sensors, computer vision cameras, and software integrations to create a live digital twin of your facility. Every asset, every movement, and every delay is tracked and visualized in real-time.",
    features: [
  ...
  "shipper-operating-system": {
    ...
    overviewText: "Stop dealing with fragmented data silos. The Unified Shipper Ecosystem integrates your existing Warehouse Management System (WMS), Transportation Management System (TMS), and Enterprise Resource Planning (ERP) into a single, cohesive command center.",
    features: [
  ...
  "agentic-ai-yard": {
    ...
    kicker: "AGENTIC AI",
    description: "Leverage autonomous AI agents to orchestrate Shipper missions, manage tasks, and minimize bottlenecks.",
