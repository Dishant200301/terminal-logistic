      ...
      <div className="site-container relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 max-w-[1050px] mx-auto text-[18px] text-[#7F7F7F] leading-[25px] font-sans font-normal">
          ...
          <AnimatedSection delay={0.2}>
            <p className="mb-6">
              Our platform connects cameras, data, and workflows into one seamless layer of visibility and control. From <strong className="font-bold text-[#7F7F7F]">gate acceleration</strong> to <strong className="font-bold text-[#7F7F7F]">asset inventory, compliance, orchestration, analytics, YMS-reimagined</strong>, Terminal delivers rapid ROI: reducing costs, accelerating throughput, and unlocking new revenue opportunities for the world's largest logistics operators.
            </p>
            <p>
              With backing from leading investors and partnerships with several of the top 10 logistics companies, Terminal is <strong className="font-bold text-[#7F7F7F]">building with the industry, for the industry</strong> — setting the new standard for yard technology.
            </p>
          </AnimatedSection>
        </div>
      </div>
