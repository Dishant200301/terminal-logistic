...
const TakeChargeButton = () => {
  ...
  return (
    <MotionLink 
      to="/contact" 
      className="cta-button-premium group relative"
      initial="rest"
      whileHover="hover"
      animate="rest"
    >
...
const Footer = () => {
  return (
    <footer className="bg-[#052424] text-white relative overflow-hidden">
      ...
      {/* Footer Grid */}
      <div className="relative z-20 py-12 md:py-20 lg:py-12">
        <div className="site-container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-12 md:gap-x-8 md:gap-y-16 xl:gap-2">
            ...
            <div className="flex flex-col items-start mb-8 md:mb-0">
              <Link to="/" className="flex items-center gap-3 mb-6 group">
                <div className="w-10 h-10 rounded flex items-center justify-center transition-transform duration-300 group-hover:scale-110">
                  <img src="/logo.png" alt="Terminal" className="w-full h-full object-contain" />
                </div>
                <span className="font-bold text-[32px] tracking-tighter text-white font-sans">Terminal</span>
              </Link>
            ...
            <div className="mb-0">
              ...
              <ul className="flex flex-col gap-[9.6px]">
                ...
                <PremiumFooterLink to="/services">Yard Operating System</PremiumFooterLink>
                <PremiumFooterLink to="/services/ai-yard">The Agentic AI Yard</PremiumFooterLink>
                <PremiumFooterLink to="/calculator">Yard Efficiency Calculator</PremiumFooterLink>
              </ul>
            </div>
            ...
            <div className="mb-0">
              ...
              <ul className="flex flex-col gap-[9.6px]">
                ...
                <PremiumFooterLink to="/resources">Resources</PremiumFooterLink>
          ...
          <div className="mt-12 md:mt-24 flex flex-col md:flex-row justify-between items-start md:items-end gap-8 relative pb-8 md:pb-0">
            <div className="flex flex-col gap-2">
              <p className="text-[11px] text-white/30 font-medium tracking-tight">
                Copyright Terminal Industries © {new Date().getFullYear()} All Rights Reserved
              </p>
