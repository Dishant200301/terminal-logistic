...
- **Unified Ecosystem**: Deep integrations with major WMS, TMS, and ERP providers (SAP, Manhattan, BlueYonder).
...
```bash
├── public/                 # Static assets (logos, images, sitemap)
├── src/
│   ├── components/         # Reusable UI components
│   ├── data/               # Project content and mock data
